 ...
 *
 */
public class ItemFrostbiteScroll extends ItemBase
{
	...
	{		
		...
		if (player.inventory.getCurrentItem().getItem() == ModItems.FROSTBITE_SCROLL && stats != null)
		{
			if (!world.isRemote && stats.getMana() >= 10)
			{
				...
				double y = look.y;
				double z = look.z;
				EntityIcebolt entity = new EntityIcebolt(world, x, y, z, 1.0F, 0F, player, stack, 5);
