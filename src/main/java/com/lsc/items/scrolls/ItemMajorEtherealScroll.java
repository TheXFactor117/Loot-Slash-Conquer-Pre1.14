 ...
 *
 */
public class ItemMajorEtherealScroll extends ItemBase
{
	...
	{		
		...
		if (player.inventory.getCurrentItem().getItem() == ModItems.MAJOR_ETHEREAL_SCROLL && stats != null)
		{
			if (!world.isRemote && stats.getMana() >= 10)
			{
				player.heal((float) (player.getMaxHealth() * 0.5));
