 ...
 *
 */
public class AttributeLightningDamage extends AttributeBaseWeapon
{
	...
	public void onHit(ItemStack stack, float damage, EntityLivingBase attacker, EntityLivingBase enemy)
	{
		...
		enemy.attackEntityFrom(LSCDamageSource.causeLightningDamage(attacker), (float) this.getAttributeValue(NBTHelper.loadStackNBT(stack)));
	}
