package com.thexfactor117.minehackslash.network;
		...
		{			
			...
			mainThread.addScheduledTask(new Runnable()
			{
				...
				public void run() 
				{
					...
					{
						player.openGui(MineHackSlash.instance, GuiHandler.CLASS_SELECTION, player.getEntityWorld(), player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
					}
				}
			});
