...
public class GuiPlayerInformation extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		if (player != null && playerInfo != null)
		{
			...
			String experience = I18n.format("minehackslash.gui.playerinfo.experience") + ": " + playerInfo.getPlayerExperience() + " / " + playerInfo.getLevelUpExperience(playerInfo.getPlayerLevel());
			...
			this.drawString(this.fontRenderer, I18n.format("minehackslash.gui.playerinfo.skillpoints") + ": " + playerInfo.getSkillPoints(), this.width / 2 - 50, 70, 0xFFFFFF); // skill points
		}
	}
