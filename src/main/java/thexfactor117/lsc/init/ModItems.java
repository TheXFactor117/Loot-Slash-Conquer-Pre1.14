...
import thexfactor117.lsc.items.scrolls.ItemBlizzardScroll;
import thexfactor117.lsc.items.scrolls.ItemDischargeScroll;
import thexfactor117.lsc.items.scrolls.ItemFireballScroll;
import thexfactor117.lsc.items.scrolls.ItemFirestormScroll;
import thexfactor117.lsc.items.scrolls.ItemFrostbiteScroll;
import thexfactor117.lsc.items.scrolls.ItemInvisibilityScroll;
import thexfactor117.lsc.items.scrolls.ItemMajorEtherealScroll;
import thexfactor117.lsc.items.scrolls.ItemMinorEtherealScroll;
import thexfactor117.lsc.items.scrolls.ItemVoidScroll;
