...
import thexfactor117.lsc.items.base.ItemRanged;
import thexfactor117.lsc.items.base.ItemTest;
import thexfactor117.lsc.items.magical.ItemBlazefury;
import thexfactor117.lsc.items.magical.ItemEpilogue;
import thexfactor117.lsc.items.magical.ItemGazeOfTruth;
import thexfactor117.lsc.items.magical.ItemMoonlitRod;
import thexfactor117.lsc.items.magical.ItemVisageOfWizardry;
import thexfactor117.lsc.items.melee.ItemAlakaslam;
import thexfactor117.lsc.items.melee.ItemAnnihilation;
import thexfactor117.lsc.items.melee.ItemDivineRapier;
import thexfactor117.lsc.items.melee.ItemDoomshadow;
import thexfactor117.lsc.items.melee.ItemExcaliburRapier;
import thexfactor117.lsc.items.melee.ItemGoldenPummel;
import thexfactor117.lsc.items.melee.ItemRequiem;
import thexfactor117.lsc.items.melee.ItemShadowfall;
