 ...
 *
 */
public class ItemEpilogue extends ItemMagical implements ISpecial
{
	public ItemEpilogue(String name, double baseDamage, double attackSpeed, int manaPerUse, int durability) 
	{
